...
class Quadrotor():
    ...
    def convert_force_to_rotor_speed(self,forces):
        ...
        u3 = forces[2]
        u4 = forces[3]
        w1 = sqrt(u1/(4*self.Kf)-(sqrt(2)*u2)/(4*self.Kf*self.l)-(sqrt(2)*u3)/(4*self.Kf*self.l)-u4/(4*self.Km*self.Kf))
        w2 = sqrt(u1/(4*self.Kf)-(sqrt(2)*u2)/(4*self.Kf*self.l)+(sqrt(2)*u3)/(4*self.Kf*self.l)+u4/(4*self.Km*self.Kf))
        w3 = sqrt(u1/(4*self.Kf)+(sqrt(2)*u2)/(4*self.Kf*self.l)+(sqrt(2)*u3)/(4*self.Kf*self.l)-u4/(4*self.Km*self.Kf))
        w4 = sqrt(u1/(4*self.Kf)+(sqrt(2)*u2)/(4*self.Kf*self.l)-(sqrt(2)*u3)/(4*self.Kf*self.l)+u4/(4*self.Km*self.Kf))
        return [w1,w2,w3,w4]
